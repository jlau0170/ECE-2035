...
GameInputs read_inputs() 
{
    ...
    game.b1 = button3; //top button on breadboard is  connected to p23
    game.b2 = button2; //middle button on breadboard is  connected to p22
    game.b3 = button1; //bottom button ob breadboard is  connected to p21
    
    acc.readXGravity(&game.ax);
    acc.readYGravity(&game.ay);
    acc.readZGravity(&game.az);
