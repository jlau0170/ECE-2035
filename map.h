...
void add_red_wall(int x, int y, int dir, int len);
void add_blue_wall(int x, int y, int dir, int len);
...
void add_red_plant(int x, int y);
...
void add_blue_ladder(int u, int v);
